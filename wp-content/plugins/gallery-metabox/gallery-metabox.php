...
class BE_Gallery_Metabox
{
	...
	public function metabox_add() {
		...
		$post_types		= apply_filters( 'be_gallery_metabox_post_types', array( 'wp_projects','page') );
		...
		foreach( $post_types as $post_type ) {
			...
			if( apply_filters( 'be_gallery_metabox_limit', true, $post_id ) ) {
				// Add Metabox
				add_meta_box( 'be_gallery_metabox', __( 'Gallery files', 'gallery-metabox' ), array( $this, 'gallery_metabox' ), $post_type, $context, $priority );
